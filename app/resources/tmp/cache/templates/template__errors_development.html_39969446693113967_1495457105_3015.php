...
<div class="lithium-exception-class">
	...
	<?php if ($code = $exception->getCode()): ?>
		<span class="lithium-exception-code">(code <?php echo $h($code); ?>)</span>
	<?php endif ?>
</div>

<div class="lithium-exception-message">
	<pre><code><?php echo $h($exception->getMessage()); ?></code></pre>
</div>
	...
	<ol>
		<?php foreach ($stack as $id => $frame): ?>
			...
			<li>
				...
				<div id="code-<?php echo $h($id); ?>" style="display: none;">
